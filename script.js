document.addEventListener('DOMContentLoaded', function () {
  ...
  document.body.addEventListener('submit', function (e) {
    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && !value) {
        ...
        if (type === 'email' && !isValidEmail(value)) {
          ...
          error = field.dataset.errorUrl || 'Please enter a valid URL.';
        } else if (field.hasAttribute('minlength')) {
          const min = parseInt(field.getAttribute('minlength'), 10);
          if (value.length < min) {
            error = field.dataset.errorMinlength || ('Minimum ' + min + ' characters required.');
          }
        } else if (field.hasAttribute('maxlength')) {
          const max = parseInt(field.getAttribute('maxlength'), 10);
          if (value.length > max) {
            error = field.dataset.errorMaxlength || ('Maximum ' + max + ' characters allowed.');
          }
        }
      }
    ...
    fetch(action, {
      ...
      .catch(function (err) {
        showFormError(form, err.message || 'Something went wrong. Please try again.');
      })
      .finally(function () {
        if (submitBtn) {
  ...
  function showFormSuccess(form) {
    ...
    msg.textContent = form.dataset.successMessage || 'Thank you! Your message has been sent successfully.';
  ...
  function showFormError(form, message) {
    ...
    const msg = document.createElement('div');
    msg.className = 'form-global-error';
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: 'f5076241-7c5a-47f3-87f2-17e03c2bb16b',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || 'f5076241-7c5a-47f3-87f2-17e03c2bb16b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f5076241-7c5a-47f3-87f2-17e03c2bb16b';
